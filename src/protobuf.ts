...
ProtoBuf.DotProto = (function (ProtoBuf, Lang) {
     ...
     * @constructor
     */
    var Parser: any = function (source) {
     ...
     * @inner
     */
    function mkId(value, mayBeNegative?: any) {
        var id = -1,
            sign = 1;
        if (value.charAt(0) == '-') {
            sign = -1;
...
ProtoBuf.Reflect = (function (ProtoBuf) {
     ...
     * @constructor
     */
    var Element: any = function (type, resolvedType, isMapKey, syntax, name) {
     ...
     */
    var Message: any = function (builder, parent, name, options, isGroup, syntax) {
    ...
    MessagePrototype.build = function (rebuild) {
        ...
        var clazz = (function (ProtoBuf, T) {
             ...
             */
            var Message: any = function (values, var_args) {
             ...
             * @inner
             */
            function cloneRaw(obj, binaryAsBase64, longsAsStrings, resolvedType?: any) {
     ...
     * @extends ProtoBuf.Reflect.Namespace
     */
    var Enum: any = function (builder, parent, name, options, syntax) {
        Namespace.call(this, builder, parent, name, options, syntax);
...
ProtoBuf.Builder = (function (ProtoBuf, Lang, Reflect) {
     ...
     * @constructor
     */
    var Builder: any = function (options) {
